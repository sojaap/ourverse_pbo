...
class ButtonEditor extends DefaultCellEditor {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (row != -1) { // Pastikan ada baris yang dipilih
                    ...
                    if (newStock != null && !newStock.trim().isEmpty()) {
                        ...
                        JOptionPane.showMessageDialog(button, "Stok untuk " + merch.name + " telah diperbarui menjadi " + newStock);
                    } else {
                        JOptionPane.showMessageDialog(button, "Stok tidak boleh kosong!", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
    ...
    private JPanel createEditStockPanel() {
        ...
        saveButton.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(null, "Kode merchandise tidak ditemukan!", "Error", JOptionPane.ERROR_MESSAGE);
        });
